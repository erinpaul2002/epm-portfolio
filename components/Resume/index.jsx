  ...
  return (
    <article className={styles.resume} data-page="resume">
      ...
      <section className={styles.timeline}>
        ...
        <ol className={styles.timelineList}>
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>CMI Public School Chalakudy</h4>
            <span>2009 - 2021</span>
          ...
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>Model Engineering College Thrikkakara</h4>
            <span>2021 — 2025</span>
            <p className={styles.timelineText}>
      ...
      <section className={styles.timeline}>
        ...
        <ol className={styles.timelineList}>
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>Full Stack Intern, Metashot, Bengaluru, India</h4>
      ...
      <section className={styles.timeline}>
        ...
        <ol className={styles.timelineList}>
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>SnapSync</h4>
            <p className={styles.timelineText}>
          ...
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>CryptoX</h4>
            <p className={styles.timelineText}>
          ...
          <li className={styles.timelineItem}>
            <h4 className={`h4 ${styles.timelineItemTitle}`}>YouTube Transcriber</h4>
            <p className={styles.timelineText}>
